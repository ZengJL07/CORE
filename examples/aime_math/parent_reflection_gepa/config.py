...
class ParentReflectionGEPAConfig:
    ...
    reflect_train_batch_size: int = 3
    probe_val_batch_size: int = 0
    ...
    def from_env(cls) -> "ParentReflectionGEPAConfig":
        return cls(
            ...
            reflect_train_batch_size=_env_int("AIME_PRG_REFLECT_TRAIN_BATCH_SIZE", 3),
            probe_val_batch_size=_env_int("AIME_PRG_PROBE_VAL_BATCH_SIZE", 0),
