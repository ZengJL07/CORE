...
TEST_ROOT="$REPO_ROOT/examples/aime_math/test/aime_small/gepa"
...
export AIME_MAX_METRIC_CALLS="${AIME_MAX_METRIC_CALLS:-0}"
...
export AIME_MAX_TRAIN_EXAMPLES="${AIME_MAX_TRAIN_EXAMPLES:-20}"
export AIME_MAX_VAL_EXAMPLES="${AIME_MAX_VAL_EXAMPLES:-20}"
export AIME_MAX_TEST_EXAMPLES="${AIME_MAX_TEST_EXAMPLES:-0}"
