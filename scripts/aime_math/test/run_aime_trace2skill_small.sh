...
TEST_ROOT="$REPO_ROOT/examples/aime_math/test/aime_small/trace2skill_baseline"
...
export AIME_TRACE2SKILL_B="${AIME_TRACE2SKILL_B:-4}"
export AIME_TRACE2SKILL_MODE="${AIME_TRACE2SKILL_MODE:-combined}"
export AIME_TRACE2SKILL_ERROR_ANALYST_MAX_TURNS="${AIME_TRACE2SKILL_ERROR_ANALYST_MAX_TURNS:-2}"
