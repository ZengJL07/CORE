...
TEST_ROOT="$REPO_ROOT/examples/aime_math/test/aime_small/textgrad_original"
...
export AIME_TEXTGRAD_BATCH_SIZE="${AIME_TEXTGRAD_BATCH_SIZE:-2}"
export AIME_TEXTGRAD_MAX_EPOCHS="${AIME_TEXTGRAD_MAX_EPOCHS:-1}"
export AIME_TEXTGRAD_MAX_STEPS="${AIME_TEXTGRAD_MAX_STEPS:-6}"
